    ...
    public PluginFlag Chat(MessageContext context, string link)
    {
        ...
        try
        {
	        ...
	        conversation.Messages.Add(new Message(
		        ...
		        "3. 如果网页文本涵盖了其他的链接，或者 X 帖子等，你可以进一步基于这些内容进行搜索，并且另外加一行，相关内容总结：xxx。如果不包含这些内容，你可以忽视本规则。" +
		        "4. 你的总结需要尽可能的精简回答，概括核心的内容信息。" +
		        "5. 你只需要总结用户提供的网页文本中的可解释内容。" +
		        "6. 如果内容中有多个独立的内容，请分段独立表述。" +
		        "7. 请使用中文进行概要总结。\n"
	        ));
